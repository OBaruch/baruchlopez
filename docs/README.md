...
Separar la documentacion de proyecto, mirrors y tooling del sitio publico estatico. El sitio publicado debe seguir siendo simple; `docs/` sirve para registrar contexto, decisiones y referencias mientras se construye una version mas ambiciosa de `baruchlopez.com` en el futuro.
